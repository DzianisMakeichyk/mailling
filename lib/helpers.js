...
Handlebars.registerHelper('makeButton', function(text, font_size, font_weight, text_transform, url, width_btn, height_btn, bg_color, border_color, border_radius, text_color, align) {
    ...
    var result ='' +
        '<table border="0" cellpadding="0" cellspacing="0" align="' + align + '" class="buttonScale">' +
          '<tbody>' +
            '<tr>' +
              '<td align="' + align + '" height="' + height_btn + '" width="'+ width_btn + '" bgcolor="' + bg_color + '" style="-webkit-border-radius:'+ border_radius + ';-moz-border-radius:' + border_radius + ';border-radius:'+ border_radius +'px;border-bottom: 3px solid #'+ border_color +';font-weight:'+ font_weight +';font-family:Arial,sans-serif,;color:#'+ text_color +';text-transform:'+ text_transform +';text-align: center;"mc:edit="6">' +
...
Handlebars.registerHelper('headerPic', function(link_header, url_header, alt_header) {
    ...
    var result ='' +
        ...
        '<a href="' + link_header + '" style="text-decoration: none;"><img src="' + url_header + '/?utm_content=top_pic" width="600" alt="' + alt_header + '" border="0" class="hover" mc:edit="5"></a>' +
        '</td>' +
        '</tr>' +
        '</tbody>' +
        '</table>' +
    ...
    var result ='<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" bgcolor="#ffffff"mc:repeatable="module5">' +
        ...
        '<!-- Divider -->' +
                      '<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full">' +
                        '<tbody>' +
                          '<tr>' +
                            '<td width="100%" height="' + space_height + 'px"></td>' +
                          '</tr>' +
                        '</tbody>' +
                      '</table>' +
        '<!-- End Divider -->' +
