          ...
          '<tbody>' +
            '<tr>' +
              '<td align="' + align + '" height="' + height_btn + '" width="'+ width_btn + '" bgcolor="' + bg_color + '" style="-webkit-border-radius:'+ border_radius + 'px;-moz-border-radius:' + border_radius + 'px;border-radius:'+ border_radius +'px;border-bottom: 3px solid #'+ border_color +';font-weight:'+ font_weight +';font-family:Arial,sans-serif,;color:#'+ text_color +';text-transform:'+ text_transform +';text-align: center;"mc:edit="6">' +
                '<a href="' + url + '/?utm_content=btn_apl" style="font-family: Arial, sans-serif;color:#' + text_color + ';font-size:' + font_size + 'px;text-decoration:none; line-height:' + font_size + 'px; text-align: center;">' + options.fn(this) + '</a>' +
              '</td>' +
            '</tr>' +
          '</tbody>' +
        '</table>' +
...
Handlebars.registerHelper('column', function(column_width, options) {
    ...
    return new Handlebars.SafeString(
        '<!-- Column -->' +
        '<table width="' + column_width + '" border="0" cellpadding="0" cellspacing="0" align="center" valign="top" style="display: inline-block;border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;vertical-align: inherit;" class="fullCenter">' +
        '<tbody>' +
        '<tr>' +
        '<td width="100%">'
        + options.fn(this) +
