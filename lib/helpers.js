'use strict';
exports.capitals = function(str) {
    Handlebars.registerHelper("makeButton", function (text, url, utm, width_btn, color_btn) {
        ...
        var theButton = '<table border="0" cellpadding="0" cellspacing="0" align="left" class="buttonScale">' +
            ...
            '<a href=" + url + utm" style="color: #ffffff; font-size: 12px; text-decoration: none; line-height: 28px;">text</a>' +
            ' </td>' +
            ' </tr> ' +
            '</tbody> ' +
            '</table>';
