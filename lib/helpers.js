...
Handlebars.registerHelper('list', function(side_col, color_dot, size_dot, font_color, font_size, font_weight, list_width, context, options) {
    ...
    var ret = '<table width="100%" border="0" cellpadding="0" cellspacing="0" align="' + side_col + '" class="full" >' +
    '<tbody>' +
    '<tr>' +
    ...
    for(var i=0, j=context.length; i<j; i++) {
        ret = ret + '<li align="' + side_col + '" style="margin: auto; max-width:' + list_width + ';text-align: ' + side_col + ';padding: 0; white-space: normal; color: #' + color_dot + '; line-height: 140%; font-size: ' + size_dot + 'px;list-style-position: inside;">' +
